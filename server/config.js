...
export const mediaUploadDir = process.env.MEDIA_UPLOAD_DIR || path.join(path.dirname(dataFilePath), "uploads");
export const mediaUploadMaxBytes = Number.parseInt(process.env.MEDIA_UPLOAD_MAX_BYTES || "", 10) || 15 * 1024 * 1024;
export const mediaUploadJsonLimitBytes = Math.ceil(mediaUploadMaxBytes * 1.4) + 16 * 1024;
