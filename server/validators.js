...
export const resourceDefinitions = {
  ...
  content: {
    ...
    allowedFields: ["title", "type", "date", "status", "stage", "owner", "channel", "campaignId", "summary"],
    defaults: {
      date: null,
      status: "Draft",
      stage: "Ideas",
  ...
  "social-posts": {
    ...
    allowedFields: ["title", "channel", "status", "publishStatus", "scheduledFor", "owner", "copy", "campaignId", "lastPublishError", "publishedAt", "externalPostId"],
    defaults: {
      status: "Queued",
